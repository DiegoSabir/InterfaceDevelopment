...
class Ui_acercaWind(object):
    def setupUi(self, acercaWind):
        ...
        self.label_3.setPixmap(QtGui.QPixmap("../img/logo.ico"))
    ...
    def retranslateUi(self, acercaWind):
        ...
        self.label_2.setText(_translate("acercaWind", "Version: 1.2.0"))
        self.label_4.setText(_translate("acercaWind", "Servicio de transporte privado"))
        self.label_5.setText(_translate("acercaWind", "21/12/1998 - Diego Ribas González"))
        ...
        self.label_8.setText(_translate("acercaWind", "2023/2024 - IES de Teis"))
