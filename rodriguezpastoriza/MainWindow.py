...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(".\\templates\\../../../.designer/img/car-side-view-in-a-rounded-square_icon-icons.com_70773.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.btnCalendar.setGeometry(QtCore.QRect(730, 10, 25, 25))
        self.btnCalendar.setMinimumSize(QtCore.QSize(25, 25))
        self.btnCalendar.setMaximumSize(QtCore.QSize(25, 25))
        self.btnCalendar.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(".\\templates\\../../../.designer/img/schedule.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.txtDatadriver.setGeometry(QtCore.QRect(630, 10, 80, 20))
        ...
        self.lblDatadriver.setGeometry(QtCore.QRect(540, 10, 80, 20))
        self.lblDatadriver.setMinimumSize(QtCore.QSize(80, 20))
        self.lblDatadriver.setMaximumSize(QtCore.QSize(80, 20))
        ...
        self.lblEstado.setGeometry(QtCore.QRect(530, 140, 80, 20))
        ...
        self.rbtAlta.setGeometry(QtCore.QRect(720, 140, 61, 17))
        ...
        self.rbtBaja.setGeometry(QtCore.QRect(810, 140, 61, 17))
        ...
        self.rbtTodos.setGeometry(QtCore.QRect(640, 140, 61, 17))
        ...
        self.lblformasalario = QtWidgets.QLabel(parent=self.frngestdrive)
        self.lblformasalario.setGeometry(QtCore.QRect(410, 140, 60, 20))
        self.lblformasalario.setMinimumSize(QtCore.QSize(60, 20))
        self.lblformasalario.setMaximumSize(QtCore.QSize(60, 20))
        self.lblformasalario.setText("")
        self.lblformasalario.setObjectName("lblformasalario")
        self.btnBuscar = QtWidgets.QPushButton(parent=self.frngestdrive)
        self.btnBuscar.setGeometry(QtCore.QRect(500, 10, 24, 24))
        self.btnBuscar.setMinimumSize(QtCore.QSize(24, 24))
        self.btnBuscar.setMaximumSize(QtCore.QSize(24, 24))
        self.btnBuscar.setText("")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(".\\templates\\../../../.designer/img/busca.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"}")
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(".\\templates\\../../../../../.designer/img/atajo salir.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon3.addPixmap(QtGui.QPixmap(".\\templates\\../../../.designer/img/atajo salir.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.On)
        ...
        icon4.addPixmap(QtGui.QPixmap(".\\templates\\../../../.designer/img/recargar.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.On)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(".\\templates\\../../../.designer/img/Crear.jpg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(".\\templates\\../../../.designer/img/Restaurar.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.actionImportar_Datos_CSV = QtGui.QAction(parent=MainWindow)
        self.actionImportar_Datos_CSV.setObjectName("actionImportar_Datos_CSV")
        ...
        self.menuHerramientas.addAction(self.actionImportar_Datos_CSV)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionCrear_Copia_Seguridad.setText(_translate("MainWindow", "Crear copia de seguridad"))
        self.actionCrear_Copia_Seguridad.setShortcut(_translate("MainWindow", "Alt+S"))
        self.actionRestaurar_Copia_Seguridad.setText(_translate("MainWindow", "Restaurar copia de seguridad"))
        ...
        self.actionImportar_Datos_CSV.setText(_translate("MainWindow", "Importar Datos xls"))
